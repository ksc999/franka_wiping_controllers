...
#include <franka_wiping_controllers/force_controller.h>
...
void ForceController::desiredMassParamCallback(
    franka_wiping_controllers::desired_mass_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_wiping_controllers::ForceController,
